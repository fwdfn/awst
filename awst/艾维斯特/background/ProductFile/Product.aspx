<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="艾维斯特.background.ProductFile.ProductManager" %>
            ...
            <asp:GridView ID="gv" runat="server" AutoGenerateColumns="false" OnRowCreated="gv_RowCreated" AllowPaging="true" PageSize="5" OnPageIndexChanging="gv_PageIndexChanging" >
                 ...
                 <Columns>
                    ...
                    <asp:BoundField DataField="id" HeaderText="编号" /> 
                     ...
                     <asp:BoundField DataField="hots" HeaderText="热度" />
                 </Columns>                
                <EmptyDataTemplate>
                    <label>无数据</label>
                </EmptyDataTemplate>
