<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Advertising.aspx.cs" Inherits="艾维斯特.background.AdvertisingFile.Advertising" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="bodyTop">
            ...
            <div class="Title">
                <span class="TitleName">广告位管理</span>
            </div>                       
            ...
            <asp:GridView ID="gv" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="2" OnPageIndexChanging="gv_PageIndexChanging" >
                 ...
                 <Columns>
                    ...
                    <asp:TemplateField HeaderText="图片">
                        <ItemTemplate>
                            <img src="<%#getSrc(Convert.ToInt32(Eval("id"))) %>" style="width:100px;height:100px;" />
                        </ItemTemplate>
                    </asp:TemplateField>
                     <asp:TemplateField HeaderText="是否隐藏">
                         <ItemTemplate>
                             <label><%#setShowOrHide(Convert.ToInt32(Eval("id"))) %></label>
                         </ItemTemplate>
                     </asp:TemplateField>
                    <asp:BoundField DataField="picpath" HeaderText="图片路径" /> 
